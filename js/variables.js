...
const templateFolderID = "urn:adsk.wipemea:fs.folder:co.PF8z0fNYT9O6K8m7gvEgIg" // APPROVED_TEMPLATES Folder
const toolURL ="https://keltbray-dd.github.io/140_Ilford_File_Uploader/"


const uploadfolders = [
    {folderName:"KELTBRAY - WIP",folderID:"urn:adsk.wipemea:fs.folder:co.yuClwjdLTveQlqdhc1wEIA"},
...
const searchFolders =[
    "urn:adsk.wipemea:fs.folder:co.yuClwjdLTveQlqdhc1wEIA", // 0C.KELTBRAY - WIP
//"urn:adsk.wipemea:fs.folder:co.NxjqFHVtRvaLgTpzPeFF2A", // 0D.BBN - WIP
"urn:adsk.wipemea:fs.folder:co.FhzeYLcBRzqaaMnyKV07wg", // 0E.SHARED
"urn:adsk.wipemea:fs.folder:co.mjodIFGFRYKq5U9B_8HyOg", // 0F.CLIENT_SHARED
"urn:adsk.wipemea:fs.folder:co.RihBxLBNRcCABHZ-8a1shA", // 0G.PUBLISHED
"urn:adsk.wipemea:fs.folder:co.85CxOUhOR2iGvzhrjLspQA", // 0H.ARCHIVED
]
const tooltips = [
